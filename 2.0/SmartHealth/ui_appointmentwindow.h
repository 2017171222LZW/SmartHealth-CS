...
public:
    ...
    void setupUi(QMainWindow *AppointmentWindow)
    {
        ...
        widget->setGeometry(QRect(100, 50, 201, 201));
        widget->setStyleSheet(QStringLiteral("background-image: url(:/img/Customer Copy.png);"));
        ...
        appointmentTime->setGeometry(QRect(500, 500, 61, 31));
        dateLabel = new QLabel(centralwidget);
        dateLabel->setObjectName(QStringLiteral("dateLabel"));
        dateLabel->setGeometry(QRect(570, 500, 121, 31));
