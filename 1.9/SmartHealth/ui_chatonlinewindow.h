...
public:
    ...
    void setupUi(QMainWindow *ChatOnlineWindow)
    {
        ...
        ChatOnlineWindow->resize(842, 711);
        centralwidget = new QWidget(ChatOnlineWindow);
        centralwidget->setObjectName(QStringLiteral("centralwidget"));
        listWidget = new QListWidget(centralwidget);
        listWidget->setObjectName(QStringLiteral("listWidget"));
        listWidget->setGeometry(QRect(20, 65, 801, 381));
...
"} "));
        ...
        widget->setGeometry(QRect(40, 470, 781, 200));
...
""));
        ...
        textEdit->setStyleSheet(QLatin1String("bordor-radius: 8 px;\n"
...
"color : rgb(37,42,47);"));
        ...
        oppositePerson->setGeometry(QRect(20, 10, 381, 41));
